...
import it.raymanrt.orient.query.projection.CompositeProjection;
import it.raymanrt.orient.util.Commons;
import it.raymanrt.orient.util.Patterns;
...
import static it.raymanrt.orient.util.Commons.arrayToString;
import static it.raymanrt.orient.util.Commons.cast;
import static it.raymanrt.orient.util.Commons.singleQuote;
import static it.raymanrt.orient.util.Commons.singleQuoteFunction;
import static it.raymanrt.orient.util.Joiner.listJoiner;
