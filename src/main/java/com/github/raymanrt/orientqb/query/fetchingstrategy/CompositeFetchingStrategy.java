 ...
 */
public class CompositeFetchingStrategy extends FetchingStrategy {

    private final FetchingStrategy[] strategies;

    public CompositeFetchingStrategy(FetchingStrategy ... strategies) {
        super("", 0);
